...
export default {
  ...
  .then((data) => {
    ...
    // Getting every object from the array and pushing the names and images to OUR array
                ...
                this.order_items.push({ 
                  ...
                  id: item.id, order_id: item.order_id, price_per_unit: item.price_per_unit, quantity: item.quantity, product: item.product });
        });
  ...
  .then((data) => {
    ...
    // Getting every object from the array and pushing the names and images to OUR array
                data.forEach(item => {
                this.deliveries.push({ item.order_item_id: item.id, order_item_id: item.order_item_id, delivered_quantity: item.delivered_quantity});
        });
